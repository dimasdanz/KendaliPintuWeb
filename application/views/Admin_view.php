						...
						<table class="table table-hover" id="dataTables-admin">
							...
							<tbody>
								<tr>
									...
									<td><button data-toggle="modal" data-target="#modal_edit" class="btn btn-default edit" id="<?php echo $row->username?>"><i class="fa fa-edit"></i> Ubah</button></td>
								</tr>
							</tbody>
							<?php 
									$no++;
...
<div class="modal fade" id="modal_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php echo form_open(base_url().'admins/insert')?>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input class="form-control" placeholder="Nama Pengguna" type="text" name="username" value="<?php echo $username?>" required>
					</div>
					<div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<div class="row">
            		...
            		<?php echo form_open(base_url().'admins/reset_password')?>
...
<div class="modal fade" id="modal_confirm" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<?php echo form_open(base_url().'admins/delete')?>
